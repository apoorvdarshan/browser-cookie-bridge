...
npm run check
npm pack
npx --yes ./brave-codex-cookie-sync-0.10.0.tgz install-app
```
...
```bash
npx --yes ./brave-codex-cookie-sync-0.10.0.tgz preferences --source brave --target codex --cookies on --history off --menu-bar off
npx --yes ./brave-codex-cookie-sync-0.10.0.tgz sync --timeout 300
npx --yes ./brave-codex-cookie-sync-0.10.0.tgz setup --hour 9 --minute 0
npx --yes ./brave-codex-cookie-sync-0.10.0.tgz enable-login-sync
```
